...
The AGILE conference is related to GIScience conference in terms of scientific domain and contributing authors, but is different in organisational aspects. Two open questions are thus whether the GIScience conference series faces the same issues, and whether similar strategies could be applied successfully.
...
Although the replication was successful, the process was again labour-intensive, making it problematic to scale it up to assess several years of several popular journals, for example.
