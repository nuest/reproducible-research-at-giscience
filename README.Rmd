...
You can skip the installation of LaTex (recommended to use `tinytex`) and installation of LaTeX packages if you knit to HTML or run the chunks directly from RStudio.
