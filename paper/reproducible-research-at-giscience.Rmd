...
Although the replication was successful, the process was again labor-intensive, making it problematic to scale it up to assess several years of several popular journals, for example.
...
A successfull _reproducibility turn_ would not mean that every reproducible paper would be fullly reproduced, nor would this be necessary. 
