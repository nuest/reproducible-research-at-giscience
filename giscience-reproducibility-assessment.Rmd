...
assessment_sheet <- googlesheets4::read_sheet(
  ...
  col_types = "c",
  range = googlesheets4::cell_rows(1:62) # 2018, 2016, 2014
)
...
TODO: maybe an alluvial plot works better? https://www.datalorax.com/post/alluvial-plots-with-ggforce/ and https://ggforce.data-imaginist.com/

Other package: https://corybrunson.github.io/ggalluvial/
...
googledrive::drive_put("giscience-reproducibility-assessment.html", path = "https://drive.google.com/drive/folders/17EUtM_zCx1gQMea1MHN_5XSVrssxv9GA")
googledrive::drive_put("giscience-reproducibility-assessment.Rmd", path = "https://drive.google.com/drive/folders/17EUtM_zCx1gQMea1MHN_5XSVrssxv9GA")
```
