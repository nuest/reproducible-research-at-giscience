...
_Available_ (level 2) was assigned if the paper provided direct access to the materials (e.g., through a link to a personal or institutional website), but not in the form of an open and permanent identifier, such as a document object identifier (DOI).
...
The borders are vague and hence scores should be interpreted with caution. Likewise, the _Computational environment_ is also difficult to distinguish from analysis, and technology and practices for the effective management of the computing environment have reached mature states relatively recently.
