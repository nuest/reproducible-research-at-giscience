...
Afterwards the individual assessments are manually merged in the online spreadsheet and the data file is updated and comitted once more.
...
kable(means,
      ...
      caption = "Mean levels per criterion for papers") %>%
  kableExtra::kable_styling("striped", full_width = FALSE)
```
