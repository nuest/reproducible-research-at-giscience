...
However, also the related concept of replication is likely to be a challenge. Despite the GIScience conference series has a rigorous review process and high-quality proceedings, reproducibility and replicability have not been a core concern in the contributed papers. With reproducibility now being a recognized topic in the call for papers, it is time to take stock and identify action. 
