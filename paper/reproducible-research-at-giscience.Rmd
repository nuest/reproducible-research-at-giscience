...
# Preliminary results of AGILE Guidelines
<!-- could become part of results and discussion section -->

- because we could not reproduce most of the papers, these did not reach "2" > not much of an improvement?
- because we could reproduce at least n papers, the situation was better than in the past
    - step from 1 to 2 is critical, but what makes things really reproducible
    - **pro assessment**: assess the ones that were reproduced, to see if they are mostly 2s or 3s
    - 3 is important for personal interest, would allow reproduction in 5 years time
- there were no "best paper candidates" so we cannot add this year's papers to the AGILE dataset
- the successfully reproduced papers might have been the nominees - we do not know!
- ...
