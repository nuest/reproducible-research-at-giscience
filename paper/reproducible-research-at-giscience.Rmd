...
- Figure&nbsp;\@ref(fig:assessment-results) shows the distribution of the reproducibility levels for each criterion.
    - Given that we are exhaustive (all conference papers rather than a selection like in AGILE), describe level counts here. Any temporal trend? 
    - Which topics (keywords?) are more suitable to have high reproducible levels? 
    - Are there authors that have papers above average reproducible levels? Worth to highlight them?
